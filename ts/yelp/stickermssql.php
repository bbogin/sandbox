<?php 
session_set_cookie_params(3600, '/', '.thinksmart.com', true, true);
session_start(); 
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
	...
	if (verifyFormToken()) {
		...
		$username = "mozilla_user";
		$password = "Crumpet159!!!159";
		$serverName = "PDPDB-MOZ01\MSSQLSERVER, 1433"; //serverName\instanceName
		$database = "yelp_Project";
		...
		$sql = "INSERT INTO yelp (name, email, addressl1, addressl2, city, state, zip, country) VALUES (?, ?, ?, ?, ?, ?, ?, ?)";
		$params = array($name, $email, $address, $addressl2, $city, $state, $zip, $country);
